    ...
    <div className="w-full flex items-center justify-start py-4">
        ...
        >
            ...
            <AnimatePresence>
                {isClearHovered && (
                    ...
                    className="absolute -top-4 -left-2 bg-white shadow-md rounded-md px-2 py-1 "
        ...
        <div className="w-full flex items-center justify-start overflow-x-scroll gap-6  scrollbar-none">
                {FiltersData && FiltersData.map((item)=>(
                    ...
                    key={item.id} className={` font-extrabold border border-gray-300 rounded-md px-6 py-2 cursor-pointer group hover:shadow-md ${filterData?.searchTerm=== item.value && " bg-gray-300 border-gray-800  shadow-md"}`}>
...
// import { slideUpDownWithS, slideUpDownWithScale } from '../animation';
// import { FiltersData } from '../utils/helpers';
// import useFilters from '../hooks/useFilters';
// import { useQueryClient } from 'react-query';
...
//                 <AnimatePresence>
//                     {isClearHovered && (
//                         <motion.div {...slideUpDownWithScale} className="absolute -top-80 -left-2 bg-white shadow-md rounded-md px-2 py-1"
//                         onClick={clearFilter}
//                         >
//                             <p className="whitespace-nowrap text-xs">Clear all</p>
//                         </motion.div>
...
//                 {FiltersData && FiltersData.map((item) => (
//                     <div
//                         onClick={() => handleFilterValue(item.val)}
//                         key={item.id}
//                         className={`border border-gray-300 rounded-md px-6 py-2 cursor-pointer group hover:shadow-md ${
//                             filterData && filterData?.searchTerm === item.value && "bg-gray-300 shadow-sm"
//                         }`}
//                     >
...
// // import { MdLayersClear } from 'react-icons/md'
// // import { AnimatePresence,motion } from 'framer-motion'
// // import { slideUpDownWith } from '../animation'
// // import { FiltersData } from '../utils/helpers'
...
// //                     <motion.div 
// //                    {...slideUpDownWith}
// //                     className="absolute -top-80 -left-2 bg-white shadow-md
...
// //                 <div 
// //                 onClick={() => handleFilterValue(item.val)}
// //                 key={item.id} className={`border border-gray-300 
// //                 rounded-md px-6 py-2 cursor-pointer group hover:shadow-md ${   //error
// //                     filterData.searchTerm
// //                     === item.value && "bg-gray-300 shadow-sm"
// //                 }`}
// //                 >
